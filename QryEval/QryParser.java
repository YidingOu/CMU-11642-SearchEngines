...
public class QryParser {
  ...
  private static Qry createOperator(String operatorName) {
    ...
    if (operatorNameLowerCase.startsWith("#near") || operatorNameLowerCase.startsWith("#window")) {
      String[] parts = operatorNameLowerCase.split("/");
      operatorNameLowerCase = parts[0];
      // System.out.println(operatorNameLowerCase);
      operatorDistance = Integer.valueOf(parts[1].trim());
    }

    // Create the query operator.
    // System.out.println(operatorName.startsWith("#near"));
    ...
    case "#near":
      ...
      ((QryIopNear) operator).distance = operatorDistance;
      break;
    ...
    case "#window":
      ...
      ((QryIopWindow) operator).distance = operatorDistance;
      break;
  ...
  private static Qry parseString(String queryString) throws IOException, IllegalArgumentException {
    ...
    // System.out.println("debug: " + substrings[1]);
    // System.out.println("debug: " + substrings[0]);
